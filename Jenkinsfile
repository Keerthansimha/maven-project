            ...
            steps {
                sshagent(credentials: ['ssh-1']) {
                    script {
                        ...
                        if (isUnix()) {
                            sh """
                               scp  -i /home/ubuntu/.ssh/id_ed25519 -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/deployyy/target/jb-hello-world-maven-0.2.0.jar  ubuntu@ec2-54-196-223-68.compute-1.amazonaws.com:/var/www/html/myapp
